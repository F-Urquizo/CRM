...
const spanishMessages: TranslationMessages = {
    ra: {
        ...
        input: {
            ...
            references: {
                all_missing: 'No se pudieron encontrar los datos de referencias.',
        ...
        navigation: {
            ...
            no_filtered_results: 'No se encontró ningún %{resource} con los filtros actuales.',
        ...
        auth: {
            ...
            sign_in_error: 'Fallo de autenticación, por favor intenta nuevamente',
        ...
        notification: {
            ...
            data_provider_error: 'Error del dataProvider. Consulta la consola para más detalles.',
        ...
        configurable: {
            ...
            configureMode: 'Configura esta página',
            inspector: {
                title: 'Inspector',
